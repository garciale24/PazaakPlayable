  ...
  return (
    <div className="howToPlay">
      ...
      <div class="row align-items-center my-2">
          ...
          </div>      <iframe title="how to play pazaak" src="https://docs.google.com/document/d/e/2PACX-1vRKV3acIaeO-nrlKP8sONu5RXFPfCkkDiY8EwVf05YhFMGuvNEvj44EOJ5OWRoSJdzEDWtR2ox4MfPc/pub?embedded=true" height="1850" width= "850" seamless="seamless" frameborder="0" 
      ></iframe>
