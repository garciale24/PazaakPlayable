'''
This file contains code that allows for a playable version of the Pazaak game (Human vs Vanilla MCTS) 
'''
...
def main() -> None:
    ...
    pazaakGame.mctsVersion = "VanillaP2"
    draw_window(pazaakGame)
