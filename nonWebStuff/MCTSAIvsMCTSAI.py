'''
This file contains code that allows for adversarial AI's (Vanialla MCTS vs Vanilla MCTS)
'''
...
''' Function to use MCTS AI for player 2 '''
def player2_AI(pazaakGame: PazaakState) -> None:
    if pazaakGame.P2setVal > 10: pazaakGame = monte_carlo_algorithm(pazaakGame)
    return pazaakGame

''' Function to use MCTS AI for player 1'''
...
def main() -> None:
    ...
    # Start time for games to be played
    ...
    # Print total time taken to play all games as well as player 1 and 2 wins
