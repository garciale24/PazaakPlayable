'''
This file contains code that allows for adversarial AI's (Simple AI vs Simple AI)
'''
...
def main() -> None:
    ...
    while gamesIdx < gamesAmt:
        ...
        while (pazaakGame.P1gamesWon < 3) and (pazaakGame.P2gamesWon < 3):
            ...
            # function to play 1 game of pazaak
            rounds_checker, rounds_flag, playerTurn = play1game(pazaakGame, playerTurn, rounds_checker, rounds_flag)
    ...
    print("P1Wins:", str(p1Wins), "P2Wins:", str(p2Wins))
    return None
