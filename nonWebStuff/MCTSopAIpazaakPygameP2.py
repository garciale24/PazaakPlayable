'''
This file contains code that allows for a playable version of the Pazaak game (Open Loop MCTS vs Human) 
'''
...
''' Function to use Open Loop MCTS '''
def player1_AI(pazaakGame: PazaakState) -> None:
    P1sideCardsTemp = pazaakGame.P1sideCards
    retpazaakGame = monte_carlo_algorithmOpenLoop(pazaakGame)
...
def main() -> None:
    ...
    pazaakGame.mctsVersion = "Open LoopP2"
    draw_window(pazaakGame)
