'''
This file contains code that allows for adversarial AI's (Vanialla MCTS vs no UCB MCTS)
'''
...
def player2_AI(pazaakGame: PazaakState) -> None:
    if pazaakGame.P2setVal > 10: pazaakGame = monte_carlo_algorithmNoUCB(pazaakGame)
    return pazaakGame

''' Function to use Vanilla MCTS '''
...
def main() -> None:
    ...
    # Print total time take plus player 1 and 2 wins
    print(end_time - start_time, "End Time(seconds)")
